...
with_node \
  ...
  --target "/Users/ghost/LumiApp/lumityo-mobileapp/ios/Pods/Target Support Files/Pods-Lumity/ExpoModulesProvider.swift" \
  --platform "apple" \
  --packages "expo-asset" "expo-constants" "expo-dev-launcher" "expo-dev-menu" "expo-eas-client" "expo-file-system" "expo-font" "expo-keep-awake" "expo-updates"
